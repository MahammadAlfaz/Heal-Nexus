      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="border-0 shadow-lg rounded-2xl">
          ...
          <CardContent className="space-y-4">
            <Button className="w-full justify-start bg-blue-50 text-blue-700 border border-blue-200 rounded-xl hover:bg-blue-100">
              <Plus className="w-4 h-4 mr-2" />
              Add Emergency Slot
            </Button>
            
            <Button className="w-full justify-start bg-yellow-50 text-yellow-700 border border-yellow-200 rounded-xl hover:bg-yellow-100">
              <Calendar className="w-4 h-4 mr-2" />
              Reschedule All Today
            </Button>
            
            <Button className="w-full justify-start bg-green-50 text-green-700 border border-green-200 rounded-xl hover:bg-green-100">
              <CheckCircle className="w-4 h-4 mr-2" />
              Confirm All Pending
            </Button>
            
            <Button className="w-full justify-start bg-red-50 text-red-700 border border-red-200 rounded-xl hover:bg-red-100">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="border-0 shadow-lg rounded-2xl md:col-span-2">
          ...
          <CardContent>
            ...
            />
            <Button className="mt-4 bg-primary hover:bg-primary/90 text-white rounded-xl">
              Save Notes
            </Button>
          </CardContent>
        </Card>
      ...
      <main className="flex-1 p-8">
        <div className="mb-6">
          <div className="flex gap-2">
            ...
            <Button 
              variant={activeSection === 'availability' ? 'default' : 'outline'}
