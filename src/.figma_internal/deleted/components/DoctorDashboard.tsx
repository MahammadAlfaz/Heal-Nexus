      ...
      <Card className="border-0 shadow-lg rounded-2xl">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <select className="px-3 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
            ...
            <input
              type="date"
              className="px-3 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
            />
          </div>
        </CardContent>
      </Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
                rows={4}
              />
            </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:ml-64">
        <main className="p-4 sm:p-6 lg:p-8 pt-20 md:pt-4">
          {renderContent()}
        </main>
      </div>
    </div>
