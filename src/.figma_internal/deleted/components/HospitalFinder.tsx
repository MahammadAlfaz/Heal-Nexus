...
export function HospitalFinder({ onNavigate, userType }: HospitalFinderProps) {
  ...
  const hospitals = [
    {
      ...
      healthCards: ['ABHA', 'Ayushman Bharat', 'CGHS', 'ESI'],
      facilities: ['24x7 Emergency', 'Parking', 'Pharmacy', 'Cafeteria'],
      verified: true,
    ...
    },
    {
      ...
      rating: 4.6,
      reviews: 890,
      phone: '+91-80-25022233',
      generalBeds: 32,
      icuBeds: 8,
      emergencyBeds: 6,
      specialties: ['Gastroenterology', 'Nephrology', 'Pulmonology', 'ENT'],
      healthCards: ['ABHA', 'State Insurance', 'Private Insurance'],
      facilities: ['Emergency', 'Blood Bank', 'Pharmacy', 'ATM'],
      verified: true,
    ...
    },
    {
      ...
      healthCards: ['Ayushman Bharat', 'CGHS', 'Private Insurance'],
      facilities: ['24x7 Emergency', 'Parking', 'Ambulance', 'Lab'],
      verified: true,
  ...
  const filteredHospitals = hospitals.filter(hospital => {
    ...
    const matchesHealthCard = !selectedHealthCard || selectedHealthCard === 'all' || 
                            hospital.healthCards.some(card => 
                              card.toLowerCase().includes(selectedHealthCard.toLowerCase())
                            );

    return matchesSearch && matchesSpecialty && matchesHealthCard;
  });
  ...
  const getDirections = (hospitalName: string) => {
    alert(`Opening directions to ${hospitalName} in Maps...`);
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-sm text-gray-600">({hospital.reviews} reviews)</span>
                          </div>
                        </div>
                      </div>
